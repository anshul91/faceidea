						...
						<ul>
							...
							<li class="submenu">
								...
								<ul class="list-unstyled" style="display: none;">
									<li><a href="<?php echo site_url()."candidates-list";?>">All Candidates</a></li>
									<li><a href="holidays.html">Holidays</a></li>
									<li><a href="leaves.html"><span>Leave Requests</span> <span class="badge bg-primary pull-right">1</span></a></li>
									<li><a href="attendance.html">Attendance</a></li>
									<li><a href="<?php echo site_url()."departments-list";?>">Departments</a></li>
									<li><a href="<?php echo site_url()."designations-list";?>">Designations</a></li>
								</ul>
							</li>
							<li> 
								<a href="<?php echo site_url()."edit-firm-detail";?>">Settings</a>
							</li>
							<!--<li> 
